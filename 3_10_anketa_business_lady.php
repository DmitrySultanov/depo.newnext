...
<head>
	<meta charset="UTF-8">
	<title>Анкета бизнес-леди</title>
...
<body class="gray">
	...
	<div class="wrapper">
		...
		<div class="user-template">
			<div class="after-header-panel business_lady">
				<div class="container">
					<div class="user-category">
						<img class="check" src="templates/img/tick-4.svg" alt="">
						<div class="flex align">
							<div>
								<span>Бизнес-леди</span>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="columns clearfix">
						...
						<div class="centercolumn">
							<div class="side-block">
								<div class="stage">
									<div class="sb-title">
										<h1 class="sm">Анкета бизнес-леди</h1>
									</div>
								...
								<div class="accordion mb-15">
									...
									<div class="stage acc-item">
										<div class="sb-title acc-title">
											<span>Сфера деятельности (бизнес)</span>
										</div>
											...
											<div class="form fullWidth">
												<form action="" target="post_form">
													<div class="element selectReq">
														<div class="row clearfix">
															<div class="col-9">
																<p>Наименование бизнеса</p>
																<input type="text" class="required" name="name-business" data-msg-required="Заполните поле" />
															</div>
															<div class="col-3">
																<p>Владелец бизнеса</p>
																<div class="select-req">
																	<select name="beneficiar" data-placeholder="Не выбрано" class="select-single self-select--error required" data-msg-required="Заполните поле">
																		<option></option>
																		<option>Я</option>
																		<option>Партнер</option>
																		<option>Муж</option>
																		<option>Любовник</option>
																		<option>Брат сестры мужа</option>
																	</select>
																</div>
															</div>
														</div>
													...
													<div class="element selectReq">
														<div class="row clearfix">
															<div class="col-10">
																<p>Должность</p>
																<div class="select-req">
																	<select name="position" data-placeholder="Не выбрано" class="select-req select-single required" data-msg-required="Заполните поле">
																		<option></option>
																		<option>Топ-менеджер</option>
																		<option>Лоу-менеджер</option>
													...
													<div class="element selectReq">
														<div class="row clearfix">
															<div class="col-10">
																<p>Классификация преприятия по виду бизнеса</p>
																<div class="select">
																	<select name="classification-business"  multiple="multiple" class="select-req select-participant required" data-msg-required="Заполните поле">
																		<option></option>
																		<option>Самарская область</option>
																		<option>Приморский край</option>
																		<option>Ярославская область</option>
						...
						<div class="rightcolumn">
							<div class="attention-block" id="sticky">
								<strong>Бизнес-леди –  успешная  женщина, которая создала бизнес идею и воплотила ее в жизнь, 
								занимается бизнесом, созданием коммерческих структур, ориентирована на финансовый успех.</strong>
							</div>
						</div>
					</div>
				</div>
