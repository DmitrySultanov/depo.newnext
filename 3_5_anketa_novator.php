					...
					<div class="columns clearfix">
						...
						<div class="centercolumn">
							<div class="side-block">
								<div class="stage">
									<div class="sb-title">
										<h1 class="sm">Анкета новатора и изобретателя</h1>
									</div>
						...
						<div class="rightcolumn">
							<div class="attention-block" id="sticky">
								<strong>Новатор -  физическое или юридическое лицо, которое придумывает и проводит в жизнь какие-то
								 абсолютно новые прогрессивные  идеи и приемы, в какой-либо области деятельности.</strong>
								<p>Изобретатель – физическое или юридическое лицо, занимающееся интеллектуальной деятельностью, 
								результатом которой являются новые технологии, новое в производственных операциях, новые механизмы, сооружения и т.п. </p>
							</div>
						</div>
					</div>
				</div>
