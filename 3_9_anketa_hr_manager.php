					...
					<div class="columns clearfix">
						...
						<div class="rightcolumn">
							<div class="attention-block" id="sticky">
								<strong>Кадровик -  юридическое лицо (организация), имеющая взаимоотношения с работодателями на предмет 
								подбора персонала в соответствии с установленными требованиями и  обладающего требуемой квалификацией и опытом работы.</strong>
							</div>
						</div>
					</div>
				</div>
