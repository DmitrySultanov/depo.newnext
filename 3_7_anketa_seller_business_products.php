...
<head>
	<meta charset="UTF-8">
	<title>Анкета продавец бизнес-продуктов</title>
...
<body class="gray">
	...
	<div class="wrapper">
		...
		<div class="user-template">
			<div class="after-header-panel seller_business_products">
				<div class="container">
					<div class="user-category">
						<img class="check" src="templates/img/tick-4.svg" alt="">
						<div class="flex align">
							<div>
								<span>Продавец бизнес-продуктов</span>
					...
					<div class="columns clearfix">
						...
						<div class="centercolumn">
							<div class="side-block">
								<div class="stage">
									<div class="sb-title">
										<h1 class="sm">Анкета продавца бизнес-продуктов</h1>
									</div>
						...
						<div class="rightcolumn">
							<div class="attention-block" id="sticky">
								<strong>Продавец бизнес-продуктов - физическое и юридическое лицо, предлагающие бизнес-продукты.</strong>
								<p>Бизнес-продукты не требуют вложений в развитие или проектирование, а являются продуктами или услугами, 
								которые в готовом виде предлагаются на рынке и удовлетворяют потребностям покупателей.</p>
								<p>К этой же категории участников относятся посредники и агенты.</p>
							</div>
						</div>
					</div>
				</div>
