...
<body class="gray">
	...
	<div class="wrapper">
		...
		<div class="user-template">
			<div class="after-header-panel coinvestor">
				<div class="container">
					<div class="user-category">
						<img class="check" src="templates/img/tick-4.svg" alt="">
						<div class="flex align">
							<div>
								<span>Соинвестор</span>
					...
					<div class="columns clearfix">
						...
						<div class="centercolumn">
							<div class="side-block">
								<div class="stage">
									<div class="sb-title">
										<h1 class="sm">Анкета cоинвесторa</h1>
									</div>
						...
						<div class="rightcolumn">
							<div class="attention-block" id="sticky">
								<strong>Соинвестор – физическое или юридическое лицо,  которое делает вложение собственных средств совместно с другими лицами,  
								инвестирующими  средства в один и тот же инвестиционный проект.</strong>
								<p>Для соинвестора целью участия в инвестировании является получение материальной выгоды, прирост имущества, иными словами – «доходность».</p>
							</div>
						</div>
					</div>
				</div>
