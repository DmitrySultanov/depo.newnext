					...
					<div class="columns clearfix">
						...
						<div class="rightcolumn">
							<div class="attention-block" id="sticky">
								<strong>Соинвестор – физическое или юридическое лицо, которое делает вложение собственных средств 
								совместно с другими лицами,  инвестирующими  средства в один и тот же инвестиционный проект.</strong>
								<p>Для соинвестора целью участия в инвестировании является получение материальной выгоды, прирост имущества, 
								иными словами – «доходность». </p>
							</div>
						</div>
					</div>
				</div>
