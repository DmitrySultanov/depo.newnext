...
<head>
	<meta charset="UTF-8">
	<title>Анкета нетрудоустроенный</title>
					...
					<div class="columns clearfix">
						...
						<div class="centercolumn">
							<div class="side-block">
								<div class="stage">
									<div class="sb-title">
										<h1 class="sm">Анкета нетрудоустроенного</h1>
									</div>
													...
													<div class="element selectReq">
														<div class="row clearfix">
															<div class="col-9">
																<p>Автомобиль</p>
																<div class="select-req">
																	<select name="auto" data-placeholder="Не выбрано" class="select-single self-select--error required" data-msg-required="Заполните поле">
																		<option></option>
																		<option>Ford</option>
															...
															<div class="col-3">
																<p>Права</p>
																<div class="select-req">
																	<select name="prava" data-placeholder="Не выбрано" class="select-single self-select--error required" data-msg-required="Заполните поле">
																		<option></option>
																		<option>A</option>
																		<option>B</option>
																		<option>C</option>
													...
													<div class="element selectReq">
														<div class="row clearfix">
															...
															<div class="col-3">
																<p>Судимость</p>
																<div class="select-req">
																	<select name="previous-conviction" data-placeholder="Не выбрано" class="select-single self-select--error required" data-msg-required="Заполните поле">
																		<option></option>
																		<option>Имею</option>
																		<option>Не имею</option>
																	</select>
																</div>
															</div>
														</div>
													...
													<div class="element selectReq">
														<div class="row clearfix">
															<div class="col-9">
																<p>Дети</p>
																<div class="select-req">
																	<select name="children" data-placeholder="Не выбрано" class="select-single self-select--error required" data-msg-required="Заполните поле">
																		<option></option>
																		<option>Имею</option>
																		<option>Не имею</option>
																	</select>
						...
						<div class="rightcolumn">
							<div class="attention-block" id="sticky">
								<strong>Нетрудоустроенные – физические лица, обладающие опытом и квалификацией в какой-либо сфере 
								деятельности и стремящиеся получить работу и заключить контракт с работодателем.</strong>
							</div>
						</div>
					</div>
				</div>
