					...
					<div class="columns clearfix">
						...
						<div class="rightcolumn">
							<div class="attention-block" id="sticky">
								<strong>Нетрудоустроенные – физические лица, обладающие опытом и квалификацией в какой-либо 
								сфере деятельности и стремящиеся получить работу и заключить контракт с работодателем.</strong>
							</div>
						</div>
					</div>
				</div>
